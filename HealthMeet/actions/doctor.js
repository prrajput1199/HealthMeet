...
export async function setAvailabilitySlots(formData) {
  ...
  try {
   ...
   console.log("Failed to set availability slots:", error);
...
export async function addAppointmentNotes(formData) {
  ...
  try {
    ...
    console.log("Failed to add appointment notes:", error);
...
export async function markAppointmentCompleted(formData) {
  ...
  try {
   ...
   console.log("Failed to mark appointment as completed:", error);
    throw new Error(
